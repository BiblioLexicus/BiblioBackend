# Generated by Django 3.2.12 on 2022-05-02 18:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserMediaList',
            fields=[
                ('id_users', models.ForeignKey(db_column='ID_Users', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.userlist')),
        ...
        migrations.CreateModel(
            name='WorkMediaList',
            fields=[
                ('id_works', models.ForeignKey(db_column='ID_Works', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.worklist')),
